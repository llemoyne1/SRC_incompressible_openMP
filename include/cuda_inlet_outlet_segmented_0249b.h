...
struct CudaInletOutletSegmented0249bDiagnostics {
...
#if defined(MPCD_ENABLE_CUDA_INLET_OUTLET_SEGMENTED_0249B)
...
inline bool cuda_inlet_outlet_segmented_0249b_requested() { return false; }
inline bool cuda_inlet_outlet_segmented_0249b_supported(const SimulationParams&) { return false; }
inline CudaInletOutletSegmented0249bDiagnostics try_apply_cuda_inlet_outlet_segmented_0249b(
    ParticleState&, const SimulationParams&, const FluidDomainBounds&, std::uint64_t, double) { return {}; }

#endif

inline void merge_cuda_inlet_outlet_segmented_0249b_diagnostics(
    BoundaryDiagnostics& boundary,
    const CudaInletOutletSegmented0249bDiagnostics& cudaIo)
{
