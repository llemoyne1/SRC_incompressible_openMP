...
RuntimeSummary compute_runtime_summary(const ParticleState& state,
                                       ...
                                       const ClosedCapacityResponseDiagnostics* capacity,
...
#pragma omp parallel for reduction(+:thermal) if(n > 10000)
    ...
    if (q6 != nullptr) {
        ...
        s.q6ProjectionStrengthNominal = q6->projectionStrengthNominal;
        s.q6CapacityReferenceMass = q6->capacityReferenceMass;
        s.q6CapacityTotalMass = q6->capacityTotalMass;
        s.q6CapacityOverfillRatio = q6->capacityOverfillRatio;
        s.q6CapacityQ6Factor = q6->capacityQ6Factor;
        ...
        s.q6SpeciesQ6BarycentricResidualMaxAbs = q6->speciesQ6BarycentricResidualMaxAbs;
    ...
    if (capacity != nullptr && capacity->enabled) {
        s.capacityResponseEnabled = capacity->enabled ? 1 : 0;
        s.capacityResponseComputed = capacity->computed ? 1 : 0;
        s.capacityVirialKickApplied = capacity->virialKickApplied ? 1 : 0;
        s.capacityReferenceCells = capacity->referenceCells;
        s.capacityReferenceCellMass = capacity->referenceCellMass;
        s.capacityReferenceMass = capacity->referenceMass;
        s.capacityTotalMass = capacity->totalMass;
        s.capacityOverfillMass = capacity->overfillMass;
        s.capacityOverfillRatio = capacity->overfillRatio;
        s.capacityQ6ProjectionFactor = capacity->q6ProjectionFactor;
        s.capacityQ6ProjectionStrengthEffective = capacity->q6ProjectionStrengthEffective;
        s.capacityMassRemapFactor = capacity->massRemapFactor;
        s.capacityMassRemapTargetCellMassNominal = capacity->massRemapTargetCellMassNominal;
        s.capacityMassRemapOverfillPerCell = capacity->massRemapOverfillPerCell;
        s.capacityMassRemapTargetCellMassEffective = capacity->massRemapTargetCellMassEffective;
        s.capacityVirialKBase = capacity->virialKBase;
        s.capacityVirialKFactor = capacity->virialKFactor;
        s.capacityVirialKEffective = capacity->virialKEffective;
        s.capacityVirialPressureMean = capacity->virialPressureMean;
        s.capacityVirialPressureRms = capacity->virialPressureRms;
        s.capacityVirialPressureMin = capacity->virialPressureMin;
        s.capacityVirialPressureMax = capacity->virialPressureMax;
        s.capacityVirialKickVelocityRms = capacity->virialKickVelocityRms;
        s.capacityVirialKickVelocityMaxAbs = capacity->virialKickVelocityMaxAbs;
        s.capacityVirialMomentumResidualBeforeCorrection = capacity->virialMomentumResidualBeforeCorrection;
        s.capacityVirialMomentumCorrectionVx = capacity->virialMomentumCorrectionVx;
        s.capacityVirialMomentumCorrectionVy = capacity->virialMomentumCorrectionVy;
        s.capacityWallLoadComputed = capacity->wallLoadComputed ? 1 : 0;
        s.capacityWallKineticKBT = capacity->wallKineticKBT;
        s.capacityWallSolidLengthLeft = capacity->wallSolidLengthLeft;
        s.capacityWallSolidLengthRight = capacity->wallSolidLengthRight;
        s.capacityWallSolidLengthBottom = capacity->wallSolidLengthBottom;
        s.capacityWallSolidLengthTop = capacity->wallSolidLengthTop;
        s.capacityWallSolidLengthTotal = capacity->wallSolidLengthTotal;
        s.capacityWallPressureKineticMeanLeft = capacity->wallPressureKineticMeanLeft;
        s.capacityWallPressureKineticMeanRight = capacity->wallPressureKineticMeanRight;
        s.capacityWallPressureKineticMeanBottom = capacity->wallPressureKineticMeanBottom;
        s.capacityWallPressureKineticMeanTop = capacity->wallPressureKineticMeanTop;
        s.capacityWallPressureVirialMeanLeft = capacity->wallPressureVirialMeanLeft;
        s.capacityWallPressureVirialMeanRight = capacity->wallPressureVirialMeanRight;
        s.capacityWallPressureVirialMeanBottom = capacity->wallPressureVirialMeanBottom;
        s.capacityWallPressureVirialMeanTop = capacity->wallPressureVirialMeanTop;
        s.capacityWallPressureTotalMeanLeft = capacity->wallPressureTotalMeanLeft;
        s.capacityWallPressureTotalMeanRight = capacity->wallPressureTotalMeanRight;
        s.capacityWallPressureTotalMeanBottom = capacity->wallPressureTotalMeanBottom;
        s.capacityWallPressureTotalMeanTop = capacity->wallPressureTotalMeanTop;
        s.capacityWallPressureKineticMeanAll = capacity->wallPressureKineticMeanAll;
        s.capacityWallPressureVirialMeanAll = capacity->wallPressureVirialMeanAll;
        s.capacityWallPressureTotalMeanAll = capacity->wallPressureTotalMeanAll;
        s.capacityWallForceKineticX = capacity->wallForceKineticX;
        s.capacityWallForceKineticY = capacity->wallForceKineticY;
        s.capacityWallForceVirialX = capacity->wallForceVirialX;
        s.capacityWallForceVirialY = capacity->wallForceVirialY;
        s.capacityWallForceTotalX = capacity->wallForceTotalX;
        s.capacityWallForceTotalY = capacity->wallForceTotalY;
    }
    ...
    if (resampling != nullptr && resampling->computed) {
        ...
        s.resampRemapMassCorrectionStrength = resampling->remapMassCorrectionStrength;
        ...
        s.resampMassGuardAttempted = resampling->massGuardAttempted ? 1 : 0;
        s.resampMassGuardApplied = resampling->massGuardApplied ? 1 : 0;
        s.resampMassGuardCellsConsidered = resampling->massGuardCellsConsidered;
        s.resampMassGuardCellsGuarded = resampling->massGuardCellsGuarded;
        s.resampMassGuardParticlesConsidered = resampling->massGuardParticlesConsidered;
        s.resampMassGuardParticlesAdjusted = resampling->massGuardParticlesAdjusted;
        s.resampMassGuardSkippedDryCells = resampling->massGuardSkippedDryCells;
        s.resampMassGuardSkippedEmptyCells = resampling->massGuardSkippedEmptyCells;
        s.resampMassGuardSkippedInfeasibleCells = resampling->massGuardSkippedInfeasibleCells;
        s.resampMassGuardSkippedInvalidMassCells = resampling->massGuardSkippedInvalidMassCells;
        s.resampMassGuardMinBound = resampling->massGuardMinBound;
        s.resampMassGuardMaxBound = resampling->massGuardMaxBound;
        s.resampMassGuardTargetCellMass = resampling->massGuardTargetCellMass;
        s.resampMassGuardMassBefore = resampling->massGuardMassBefore;
        s.resampMassGuardMassAfter = resampling->massGuardMassAfter;
        s.resampMassGuardMassTargetSum = resampling->massGuardMassTargetSum;
        s.resampMassGuardMassResidualRms = resampling->massGuardMassResidualRms;
        s.resampMassGuardMassResidualMaxAbs = resampling->massGuardMassResidualMaxAbs;
        s.resampMassGuardParticleMassMinBefore = resampling->massGuardParticleMassMinBefore;
        s.resampMassGuardParticleMassMaxBefore = resampling->massGuardParticleMassMaxBefore;
        s.resampMassGuardParticleMassMinAfter = resampling->massGuardParticleMassMinAfter;
        s.resampMassGuardParticleMassMaxAfter = resampling->massGuardParticleMassMaxAfter;
        s.resampMassGuardParticlesBelowMinBefore = resampling->massGuardParticlesBelowMinBefore;
        s.resampMassGuardParticlesAboveMaxBefore = resampling->massGuardParticlesAboveMaxBefore;
        s.resampMassGuardParticlesBelowMinAfter = resampling->massGuardParticlesBelowMinAfter;
        s.resampMassGuardParticlesAboveMaxAfter = resampling->massGuardParticlesAboveMaxAfter;
        s.resampMassGuardParticlesAtMinAfter = resampling->massGuardParticlesAtMinAfter;
        s.resampMassGuardParticlesAtMaxAfter = resampling->massGuardParticlesAtMaxAfter;
        s.resampMassGuardThermalEnergyTarget = resampling->massGuardThermalEnergyTarget;
        s.resampMassGuardThermalEnergyBefore = resampling->massGuardThermalEnergyBefore;
        s.resampMassGuardThermalEnergyAfter = resampling->massGuardThermalEnergyAfter;
        s.resampMassGuardThermalEnergyResidualRms = resampling->massGuardThermalEnergyResidualRms;
        s.resampMassGuardThermalEnergyResidualMaxAbs = resampling->massGuardThermalEnergyResidualMaxAbs;
        s.resampMassGuardVelocityScaleMin = resampling->massGuardVelocityScaleMin;
        s.resampMassGuardVelocityScaleMax = resampling->massGuardVelocityScaleMax;
        s.resampMassGuardMomentumResidualRms = resampling->massGuardMomentumResidualRms;
        s.resampMassGuardMomentumResidualMaxAbs = resampling->massGuardMomentumResidualMaxAbs;
        s.resampFirstMassGuardedCell = resampling->firstMassGuardedCell;
        s.resampLastMassGuardedCell = resampling->lastMassGuardedCell;
        s.resampMassGuardAllCellsFeasible = resampling->massGuardAllCellsFeasible ? 1 : 0;

        s.resampPopulationGuardAttempted = resampling->populationGuardAttempted ? 1 : 0;
        s.resampPopulationGuardApplied = resampling->populationGuardApplied ? 1 : 0;
        s.resampPopulationGuardNMin = resampling->populationGuardNMin;
        s.resampPopulationGuardNTarget = resampling->populationGuardNTarget;
        s.resampPopulationGuardNMax = resampling->populationGuardNMax;
        s.resampPopulationGuardWetCellsConsidered = resampling->populationGuardWetCellsConsidered;
        s.resampPopulationGuardUnderfullCells = resampling->populationGuardUnderfullCells;
        s.resampPopulationGuardEmptyUnderfullCells = resampling->populationGuardEmptyUnderfullCells;
        s.resampPopulationGuardOverfullCells = resampling->populationGuardOverfullCells;
        s.resampPopulationGuardCellsSplit = resampling->populationGuardCellsSplit;
        s.resampPopulationGuardCellsExtracted = resampling->populationGuardCellsExtracted;
        s.resampPopulationGuardSplitParticlesCreated = resampling->populationGuardSplitParticlesCreated;
        s.resampPopulationGuardExtractedParticles = resampling->populationGuardExtractedParticles;
        s.resampPopulationGuardSkippedNoFreeSlots = resampling->populationGuardSkippedNoFreeSlots;
        s.resampPopulationGuardSkippedEmptyCells = resampling->populationGuardSkippedEmptyCells;
        s.resampPopulationGuardSkippedSplitLimit = resampling->populationGuardSkippedSplitLimit;
        s.resampPopulationGuardSkippedExtractionLimit = resampling->populationGuardSkippedExtractionLimit;
        s.resampPopulationGuardFreeSlotsBefore = resampling->populationGuardFreeSlotsBefore;
        s.resampPopulationGuardFreeSlotsAfter = resampling->populationGuardFreeSlotsAfter;
        s.resampPopulationGuardActiveParticleDelta = resampling->populationGuardActiveParticleDelta;
        s.resampPopulationGuardSplitMass = resampling->populationGuardSplitMass;
        s.resampPopulationGuardExtractedMass = resampling->populationGuardExtractedMass;
        s.resampPopulationGuardWetNMeanBefore = resampling->populationGuardWetNMeanBefore;
        s.resampPopulationGuardWetNMeanAfter = resampling->populationGuardWetNMeanAfter;
        s.resampPopulationGuardWetNStdBefore = resampling->populationGuardWetNStdBefore;
        s.resampPopulationGuardWetNStdAfter = resampling->populationGuardWetNStdAfter;
        s.resampPopulationGuardWetNMinBefore = resampling->populationGuardWetNMinBefore;
        s.resampPopulationGuardWetNMinAfter = resampling->populationGuardWetNMinAfter;
        s.resampPopulationGuardWetLowNFractionBefore = resampling->populationGuardWetLowNFractionBefore;
        s.resampPopulationGuardWetLowNFractionAfter = resampling->populationGuardWetLowNFractionAfter;

        s.resampLatentActivationAttempted = resampling->latentActivationAttempted ? 1 : 0;
        s.resampLatentActivationApplied = resampling->latentActivationApplied ? 1 : 0;
        s.resampLatentActivationReceiverCellsConsidered = resampling->latentActivationReceiverCellsConsidered;
        s.resampLatentActivationCellsActivated = resampling->latentActivationCellsActivated;
        s.resampLatentActivationParticlesActivated = resampling->latentActivationParticlesActivated;
        s.resampLatentActivationRoleChanges = resampling->latentActivationRoleChanges;
        s.resampLatentActivationSkippedNoLatentSlots = resampling->latentActivationSkippedNoLatentSlots;
        s.resampLatentActivationSkippedInvalidReceiverCells = resampling->latentActivationSkippedInvalidReceiverCells;
        s.resampLatentActivationSkippedReceiverNotWet = resampling->latentActivationSkippedReceiverNotWet;
        s.resampLatentActivationSkippedReceiverNotPoor = resampling->latentActivationSkippedReceiverNotPoor;
        s.resampLatentActivationSkippedMaxPerCell = resampling->latentActivationSkippedMaxPerCell;
        s.resampLatentActivationLatentSlotsBefore = resampling->latentActivationLatentSlotsBefore;
        s.resampLatentActivationLatentSlotsAfter = resampling->latentActivationLatentSlotsAfter;
        s.resampLatentActivationFluidSlotsBefore = resampling->latentActivationFluidSlotsBefore;
        s.resampLatentActivationFluidSlotsAfter = resampling->latentActivationFluidSlotsAfter;
        s.resampLatentActivationTargetCellMass = resampling->latentActivationTargetCellMass;
        s.resampLatentActivationParticleMass = resampling->latentActivationParticleMass;
        s.resampLatentActivationMass = resampling->latentActivationMass;
        s.resampLatentActivationMomentumX = resampling->latentActivationMomentumX;
        s.resampLatentActivationMomentumY = resampling->latentActivationMomentumY;
        s.resampLatentActivationKineticEnergy = resampling->latentActivationKineticEnergy;
        s.resampFirstLatentActivatedParticle = resampling->firstLatentActivatedParticle == kInvalidParticleIndex
            ? -1 : static_cast<std::int64_t>(resampling->firstLatentActivatedParticle);
        s.resampLastLatentActivatedParticle = resampling->lastLatentActivatedParticle == kInvalidParticleIndex
            ? -1 : static_cast<std::int64_t>(resampling->lastLatentActivatedParticle);
        s.resampFirstLatentActivatedCell = resampling->firstLatentActivatedCell;
        s.resampLastLatentActivatedCell = resampling->lastLatentActivatedCell;
        s.resampLatentActivationAllSourcesWereLatent = resampling->latentActivationAllSourcesWereLatent ? 1 : 0;
        s.resampLatentActivationNoDryCellsActivated = resampling->latentActivationNoDryCellsActivated ? 1 : 0;
        ...
        s.resampDisabledSpeciesMutationCount = resampling->disabledSpeciesMutationCount;
    }
...
void RuntimeSummaryWriter::append(const RuntimeSummary& s) {
    ...
    out_ << s.step << ','
         ...
         << s.outletParticlesInserted << ',' << s.inletParticlesInserted << ','
         ...
         << s.q6SpeciesQ6BarycentricResidualMaxAbs << ','
         ...
         << s.resampMassGuardAttempted << ','
         << s.resampMassGuardApplied << ','
         << s.resampMassGuardCellsConsidered << ','
         << s.resampMassGuardCellsGuarded << ','
         << s.resampMassGuardParticlesConsidered << ','
         << s.resampMassGuardParticlesAdjusted << ','
         << s.resampMassGuardSkippedDryCells << ','
         << s.resampMassGuardSkippedEmptyCells << ','
         << s.resampMassGuardSkippedInfeasibleCells << ','
         << s.resampMassGuardSkippedInvalidMassCells << ','
         << s.resampMassGuardMinBound << ','
         << s.resampMassGuardMaxBound << ','
         << s.resampMassGuardTargetCellMass << ','
         << s.resampMassGuardMassBefore << ','
         << s.resampMassGuardMassAfter << ','
         << s.resampMassGuardMassTargetSum << ','
         << s.resampMassGuardMassResidualRms << ','
         << s.resampMassGuardMassResidualMaxAbs << ','
         << s.resampMassGuardParticleMassMinBefore << ','
         << s.resampMassGuardParticleMassMaxBefore << ','
         << s.resampMassGuardParticleMassMinAfter << ','
         << s.resampMassGuardParticleMassMaxAfter << ','
         << s.resampMassGuardParticlesBelowMinBefore << ','
         << s.resampMassGuardParticlesAboveMaxBefore << ','
         << s.resampMassGuardParticlesBelowMinAfter << ','
         << s.resampMassGuardParticlesAboveMaxAfter << ','
         << s.resampMassGuardParticlesAtMinAfter << ','
         << s.resampMassGuardParticlesAtMaxAfter << ','
         << s.resampMassGuardThermalEnergyTarget << ','
         << s.resampMassGuardThermalEnergyBefore << ','
         << s.resampMassGuardThermalEnergyAfter << ','
         << s.resampMassGuardThermalEnergyResidualRms << ','
         << s.resampMassGuardThermalEnergyResidualMaxAbs << ','
         << s.resampMassGuardVelocityScaleMin << ','
         << s.resampMassGuardVelocityScaleMax << ','
         << s.resampMassGuardMomentumResidualRms << ','
         << s.resampMassGuardMomentumResidualMaxAbs << ','
         << s.resampFirstMassGuardedCell << ','
         << s.resampLastMassGuardedCell << ','
         << s.resampMassGuardAllCellsFeasible << ','
         << s.resampPopulationGuardAttempted << ','
         << s.resampPopulationGuardApplied << ','
         << s.resampPopulationGuardNMin << ','
         << s.resampPopulationGuardNTarget << ','
         << s.resampPopulationGuardNMax << ','
         << s.resampPopulationGuardWetCellsConsidered << ','
         << s.resampPopulationGuardUnderfullCells << ','
         << s.resampPopulationGuardEmptyUnderfullCells << ','
         << s.resampPopulationGuardOverfullCells << ','
         << s.resampPopulationGuardCellsSplit << ','
         << s.resampPopulationGuardCellsExtracted << ','
         << s.resampPopulationGuardSplitParticlesCreated << ','
         << s.resampPopulationGuardExtractedParticles << ','
         << s.resampPopulationGuardSkippedNoFreeSlots << ','
         << s.resampPopulationGuardSkippedEmptyCells << ','
         << s.resampPopulationGuardSkippedSplitLimit << ','
         << s.resampPopulationGuardSkippedExtractionLimit << ','
         << s.resampPopulationGuardFreeSlotsBefore << ','
         << s.resampPopulationGuardFreeSlotsAfter << ','
         << s.resampPopulationGuardActiveParticleDelta << ','
         << s.resampPopulationGuardSplitMass << ','
         << s.resampPopulationGuardExtractedMass << ','
         << s.resampPopulationGuardWetNMeanBefore << ','
         << s.resampPopulationGuardWetNMeanAfter << ','
         << s.resampPopulationGuardWetNStdBefore << ','
         << s.resampPopulationGuardWetNStdAfter << ','
         << s.resampPopulationGuardWetNMinBefore << ','
         << s.resampPopulationGuardWetNMinAfter << ','
         << s.resampPopulationGuardWetLowNFractionBefore << ','
         << s.resampPopulationGuardWetLowNFractionAfter << ','
         << s.resampLatentActivationAttempted << ','
         << s.resampLatentActivationApplied << ','
         << s.resampLatentActivationReceiverCellsConsidered << ','
         << s.resampLatentActivationCellsActivated << ','
         << s.resampLatentActivationParticlesActivated << ','
         << s.resampLatentActivationRoleChanges << ','
         << s.resampLatentActivationSkippedNoLatentSlots << ','
         << s.resampLatentActivationSkippedInvalidReceiverCells << ','
         << s.resampLatentActivationSkippedReceiverNotWet << ','
         << s.resampLatentActivationSkippedReceiverNotPoor << ','
         << s.resampLatentActivationSkippedMaxPerCell << ','
         << s.resampLatentActivationLatentSlotsBefore << ','
         << s.resampLatentActivationLatentSlotsAfter << ','
         << s.resampLatentActivationFluidSlotsBefore << ','
         << s.resampLatentActivationFluidSlotsAfter << ','
         << s.resampLatentActivationTargetCellMass << ','
         << s.resampLatentActivationParticleMass << ','
         << s.resampLatentActivationMass << ','
         << s.resampLatentActivationMomentumX << ','
         << s.resampLatentActivationMomentumY << ','
         << s.resampLatentActivationKineticEnergy << ','
         << s.resampFirstLatentActivatedParticle << ','
         << s.resampLastLatentActivatedParticle << ','
         << s.resampFirstLatentActivatedCell << ','
         << s.resampLastLatentActivatedCell << ','
         << s.resampLatentActivationAllSourcesWereLatent << ','
         << s.resampLatentActivationNoDryCellsActivated << ','
         << s.resampPoolBuilt << ','
         ...
         << s.resampDisabledSpeciesMutationCount << ','
         << s.capacityResponseEnabled << ','
         << s.capacityResponseComputed << ','
         << s.capacityVirialKickApplied << ','
         << s.capacityReferenceCells << ','
         << s.capacityReferenceCellMass << ','
         << s.capacityReferenceMass << ','
         << s.capacityTotalMass << ','
         << s.capacityOverfillMass << ','
         << s.capacityOverfillRatio << ','
         << s.capacityQ6ProjectionFactor << ','
         << s.capacityQ6ProjectionStrengthEffective << ','
         << s.capacityMassRemapFactor << ','
         << s.capacityMassRemapTargetCellMassNominal << ','
         << s.capacityMassRemapOverfillPerCell << ','
         << s.capacityMassRemapTargetCellMassEffective << ','
         << s.capacityVirialKBase << ','
         << s.capacityVirialKFactor << ','
         << s.capacityVirialKEffective << ','
         << s.capacityVirialPressureMean << ','
         << s.capacityVirialPressureRms << ','
         << s.capacityVirialPressureMin << ','
         << s.capacityVirialPressureMax << ','
         << s.capacityVirialKickVelocityRms << ','
         << s.capacityVirialKickVelocityMaxAbs << ','
         << s.capacityVirialMomentumResidualBeforeCorrection << ','
         << s.capacityVirialMomentumCorrectionVx << ','
         << s.capacityVirialMomentumCorrectionVy << ','
         << s.resampRemapMassCorrectionStrength << ','
         << s.q6ProjectionStrengthNominal << ','
         << s.q6CapacityReferenceMass << ','
         << s.q6CapacityTotalMass << ','
         << s.q6CapacityOverfillRatio << ','
         << s.q6CapacityQ6Factor << ','
         << s.capacityWallLoadComputed << ','
         << s.capacityWallKineticKBT << ','
         << s.capacityWallSolidLengthLeft << ','
         << s.capacityWallSolidLengthRight << ','
         << s.capacityWallSolidLengthBottom << ','
         << s.capacityWallSolidLengthTop << ','
         << s.capacityWallSolidLengthTotal << ','
         << s.capacityWallPressureKineticMeanLeft << ','
         << s.capacityWallPressureKineticMeanRight << ','
         << s.capacityWallPressureKineticMeanBottom << ','
         << s.capacityWallPressureKineticMeanTop << ','
         << s.capacityWallPressureVirialMeanLeft << ','
         << s.capacityWallPressureVirialMeanRight << ','
         << s.capacityWallPressureVirialMeanBottom << ','
         << s.capacityWallPressureVirialMeanTop << ','
         << s.capacityWallPressureTotalMeanLeft << ','
         << s.capacityWallPressureTotalMeanRight << ','
         << s.capacityWallPressureTotalMeanBottom << ','
         << s.capacityWallPressureTotalMeanTop << ','
         << s.capacityWallPressureKineticMeanAll << ','
         << s.capacityWallPressureVirialMeanAll << ','
         << s.capacityWallPressureTotalMeanAll << ','
         << s.capacityWallForceKineticX << ','
         << s.capacityWallForceKineticY << ','
         << s.capacityWallForceVirialX << ','
         << s.capacityWallForceVirialY << ','
         << s.capacityWallForceTotalX << ','
         << s.capacityWallForceTotalY << '\n';
}
