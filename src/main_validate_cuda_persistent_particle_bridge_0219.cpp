...
int main(int argc, char** argv) {
    ...
    double maxAbsVxCpu = 0.0, maxAbsVyCpu = 0.0, maxAbsVxLegacy = 0.0, maxAbsVyLegacy = 0.0, rms = 0.0;
    std::uint64_t cpuMismatches = 0u, legacyMismatches = 0u, cellMismatches = 0u, countMismatches = 0u;
    ...
    const bool pass = cpuMismatches == 0u && legacyMismatches == 0u && cellMismatches == 0u && countMismatches == 0u && sharedDiag.invalidCellParticles == 0u;
    std::cout << std::setprecision(17)
              << "CUDA_PERSISTENT_PARTICLE_BRIDGE_0219 " << (pass ? "PASS" : "FAIL")
              ...
              << " rmsCpu=" << rms
              << " thermostatKBTAfter=" << sharedThermo.kBTAfter
              << '\n';
    return pass ? 0 : 1;
}
