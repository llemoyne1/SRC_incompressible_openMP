...
addParameter(p, 'showParticlesOnField', true, @(x) islogical(x) || isnumeric(x));
...
addParameter(p, 'particleDecimation', 1, @isnumeric);
...
addParameter(p, 'particleColorMode', 'type', @(s) ischar(s) || isstring(s));
