...
Lx="${Lx:-3.0}"; Ly="${Ly:-1.0}"; NX="${NX:-196}"; NY="${NY:-64}"
GAMMA="${GAMMA:-20}"; STEPS="${STEPS:-12000}"; DT="${DT:-0.0005}"; KBT="${KBT:-0.001}"
SEED="${SEED:-1628505}"; SUMMARY_EVERY="${SUMMARY_EVERY:-100}"; DUMP_STATE_EVERY="${DUMP_STATE_EVERY:-500}"
UIN="${UIN:-0.45}"; UINIT="${UINIT:-0.0}"; THERMOSTAT_ENABLE="${THERMOSTAT_ENABLE:-1}"
CYLINDER_CX="${CYLINDER_CX:-0.65}"; CYLINDER_CY="${CYLINDER_CY:-0.50}"; CYLINDER_R="${CYLINDER_R:-0.12}"
