...
# =============================================================================
# 0493x14as — DARCY/CHI NOZZLE, WIDE OUTLETS, GAS PRESSURE AS MEASURED COVARIATE (2-D)
#
...
# =============================================================================
CASE_LABEL="${CASE_LABEL:-0493x14as_planar_gas_jet_chi_nozzle_wide_outlets}"
RUN_MODE="src-q6-g-f"
TOPOLOGY="segmented"
...
CAMPAIGN_ROOT="${CAMPAIGN_ROOT:-runs/0493x14as_planar_gas_jet_chi_nozzle_wide_outlets_s${SURFACE_TENSION_SIGMA}_seed${SEED}}"
...
speciesDiagnosticsFilename = species_runtime_0493x14as.csv
...
echo "PATHS: runner=$ROOT/scripts/run_0493x14as_planar_gas_jet_chi_nozzle_wide_outlets.sh"
