...
#
# Aim directly inside the ~20-30 H/U established-regime window.
# With this calibration, 150000 steps = ~23.20 H/U (~28 literature periods).
# State dumps every 30000 steps are retained for recovery/inspection; this
# runner does not itself implement automatic restart.
# ---------------------------------------------------------------------------
STEPS="${STEPS:-24000}"
