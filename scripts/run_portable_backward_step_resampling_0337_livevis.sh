...
LIVE_VIS_NX="${LIVE_VIS_NX:-640}"
LIVE_VIS_NY="${LIVE_VIS_NY:-480}"
...
Lx="${Lx:-2.0}"; Ly="${Ly:-1.0}"; NX="${NX:-128}"; NY="${NY:-96}"
GAMMA="${GAMMA:-20}"; STEPS="${STEPS:-50000}"; DT="${DT:-0.0005}"; KBT="${KBT:-1}"
SEED="${SEED:-1628304}"; SUMMARY_EVERY="${SUMMARY_EVERY:-100}"; DUMP_STATE_EVERY="${DUMP_STATE_EVERY:-1000}"
UIN="${UIN:-0.9}"; UINIT="${UINIT:-0.0}"; THERMOSTAT_ENABLE="${THERMOSTAT_ENABLE:-1}"
STEP_XMIN="${STEP_XMIN:-0.0}"; STEP_XMAX="${STEP_XMAX:-1.05}"; STEP_YMIN="${STEP_YMIN:-0.0}"; STEP_YMAX="${STEP_YMAX:-0.42}"
