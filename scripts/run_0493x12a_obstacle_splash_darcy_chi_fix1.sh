...
# 0493x12a — paired obstacle-triggered splash using the existing Darcy/chi
...
#   drop D = 80 h
#   tape height H = 40 h = 0.5 D
#   tape leading-edge distance from impact centre d = 80 h = 1.0 D
#
...
CASE_LABEL="0493x12a_obstacle_splash"
RUN_MODE="${RUN_MODE:-src-q6-g-f}"
TOPOLOGY=closed_box

CAMPAIGN_ROOT="${CAMPAIGN_ROOT:-runs/0493x12a_obstacle_splash_s945_v035_fix1}"
CASES="${CASES:-rmin3 rmin4}"
...
DROP_CENTER_Y="${DROP_CENTER_Y:-1.0}"
DROP_VX="${DROP_VX:-0.0}"
...
OBSTACLE_HEIGHT_CELLS="${OBSTACLE_HEIGHT_CELLS:-40}"
OBSTACLE_DISTANCE_CELLS="${OBSTACLE_DISTANCE_CELLS:-80}"
