...
CASE_LABEL="dripping_vk_0493x10k_local_frame_specular"
RUN_MODE="${RUN_MODE:-src-q6-g-f}"
TOPOLOGY=segmented
RUN_ROOT="${RUN_ROOT:-runs/0493x10k_local_frame_specular_dripping_s4500_g01}"
...
if [[ -f "$KINCSV" ]]; then
  python3 scripts/analyze_0493x10k_local_frame_specular.py "$KINCSV"
else
