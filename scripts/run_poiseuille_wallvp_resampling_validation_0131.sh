...
POIS_PROJECTION_MAX_ITERATIONS=${POIS_PROJECTION_MAX_ITERATIONS:-500}
POIS_PROJECTION_TOLERANCE=${POIS_PROJECTION_TOLERANCE:-1.0e-10}
POIS_Q6_WARM_START=${POIS_Q6_WARM_START:-true}
POIS_Q6_REUSE_PROJECTED_DIV_DIAG=${POIS_Q6_REUSE_PROJECTED_DIV_DIAG:-true}
...
projectionMaxIterations = $POIS_PROJECTION_MAX_ITERATIONS
projectionTolerance = $POIS_PROJECTION_TOLERANCE
q6WarmStartEnable = $POIS_Q6_WARM_START
q6ReuseProjectedDivergenceDiagnostics = $POIS_Q6_REUSE_PROJECTED_DIV_DIAG
