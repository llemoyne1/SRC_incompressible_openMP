...
env | grep -E '^(MPCD_CUDA_|SRC_LIVE_VIS_|MPCD_LIVE_VIS_ENABLE=|OMP_|BIN=|CHI_FILE=|STATE_SOURCE=|INPUT_STATE=|DARCY_|TOPO_BENCHMARK_|ALPHA=|U0=|DT=|KBT=|NX=|NY=|CIRCLE_)' | sort > "$ENV_FILE"
