...
# Runs SRC CUDA classic, SRC+Q6 CPU, and SRC+Q6 CUDA. Parameters can be changed
...
run_case_0406 src_cuda_classic false cpu true src_cuda_classic
run_case_0406 src_q6_cpu true cpu false src_q6_cpu
run_case_0406 src_q6_cuda true cuda false src_q6_cuda
...
print(f"[0406-poiseuille-autonomous] q6CPU it={cpu.get('q6Iterations')} q6CUDA it={cuda.get('q6Iterations')} q6CUDA divAfter={div:.6e} meanVx classic/cpu/cuda={classic.get('meanVx')}/{cpu.get('meanVx')}/{cuda.get('meanVx')}")
METRICPY

echo "[0406-poiseuille-autonomous] SRC+Q6 CPU vs SRC+Q6 CUDA summary: $ART_DIR/src_q6_cpu_vs_src_q6_cuda_summary.csv (rc=$cpu_cmp_rc)"
echo "[0406-poiseuille-autonomous] SRC CUDA classic vs SRC+Q6 CUDA summary: $ART_DIR/src_cuda_classic_vs_src_q6_cuda_summary.csv (rc=$src_cmp_rc, differences expected)"
echo "[0406-poiseuille-autonomous] selected metrics: $ART_DIR/src_modes_metrics.csv"
