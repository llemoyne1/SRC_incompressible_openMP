#!/usr/bin/env python3
"""Generate a deterministic two-species ellipse state for 0493x9b.
...
def main() -> int:
    ...
    meta = {
        "profile": "rotated_ellipse_two_species_0493x9b",
    ...
    print(f"[0493x9b-generate] state={args.output}")
    print(f"[0493x9b-generate] metadata={meta_path}")
    return 0
