...
export TARGET=wall
export RUN_ROOT="${RUN_ROOT:-runs/0493x10m_moving_interface_static_s4500}"
...
echo "===== 0493x10m STATIC DROP / MOVING INTERFACE WALL ====="
echo "[0493x10m] sigma=$SIGMA_ACTIVE kBT=$KBT; alpha=.5 local moving wall; no B8/global receiver reaction"
...
python3 scripts/analyze_0493x10m_moving_interface_wall.py "$CSV" --mode static
