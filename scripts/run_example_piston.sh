...
Lx="${Lx:-1.0}"
Ly="${Ly:-1.0}"
PISTON_YTOP0="${PISTON_YTOP0:-0.95}"
PISTON_YTOP_VELOCITY="${PISTON_YTOP_VELOCITY:--0.01}"
...
CAP_VIRIAL_K="${CAP_VIRIAL_K:-10.0}"
...
fluidYTop0 = ${PISTON_YTOP0}
fluidYTopVelocity = ${PISTON_YTOP_VELOCITY}
...
wallUyBottom = 0.0
wallUxTop = 0.0
wallUyTop = ${PISTON_YTOP_VELOCITY}
