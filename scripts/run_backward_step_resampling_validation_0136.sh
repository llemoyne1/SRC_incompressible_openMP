...
BSTEP_PROJECTION_MAX_ITERATIONS=${BSTEP_PROJECTION_MAX_ITERATIONS:-800}
BSTEP_PROJECTION_TOLERANCE=${BSTEP_PROJECTION_TOLERANCE:-1.0e-10}
BSTEP_Q6_WARM_START=${BSTEP_Q6_WARM_START:-true}
BSTEP_Q6_REUSE_PROJECTED_DIV_DIAG=${BSTEP_Q6_REUSE_PROJECTED_DIV_DIAG:-true}
...
projectionMaxIterations = $BSTEP_PROJECTION_MAX_ITERATIONS
projectionTolerance = $BSTEP_PROJECTION_TOLERANCE
q6WarmStartEnable = $BSTEP_Q6_WARM_START
q6ReuseProjectedDivergenceDiagnostics = $BSTEP_Q6_REUSE_PROJECTED_DIV_DIAG
