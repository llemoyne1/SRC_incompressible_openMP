...
export TARGET=wall
export RUN_ROOT="${RUN_ROOT:-runs/0493x10k_local_frame_specular_static_s4500}"
...
echo "===== 0493x10k STATIC DROP / LOCAL-FRAME SPECULAR ====="
echo "[0493x10k] sigma=$SIGMA_ACTIVE kBT=$KBT; no B8/global receiver reaction"
echo "[0493x10k] v' = v - 2[(v-u_b).n]n; interface counter-impulse intentionally ignored"
...
python3 scripts/analyze_0493x10k_local_frame_specular.py "$CSV"
