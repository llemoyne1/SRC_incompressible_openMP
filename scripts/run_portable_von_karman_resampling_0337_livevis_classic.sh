...
Lx="${Lx:-1.5}"; Ly="${Ly:-0.4}"; NX="${NX:-1200}"; NY="${NY:-640}"
GAMMA="${GAMMA:-6}"; STEPS="${STEPS:-500}"; DT="${DT:-0.0005}"; KBT="${KBT:-5}"
SEED="${SEED:-1628505}"; SUMMARY_EVERY="${SUMMARY_EVERY:-1000}"; DUMP_STATE_EVERY="${DUMP_STATE_EVERY:-1000}"
UIN="${UIN:-0.9}"; UINIT="${UINIT:-0.}"; THERMOSTAT_ENABLE="${THERMOSTAT_ENABLE:-1}"
