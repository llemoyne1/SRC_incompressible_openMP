...
LIVE_VIS_FIELD="${LIVE_VIS_FIELD:-N}"
...
% Visualization modalities for the TG validation.
% Select runMode='classic' or 'resampling_split_safe'.
% Select fieldMode='N', 'speed', or 'mass'.
root = '${BASE_RUN_ROOT}';
...
echo "[0315-portable] visualization: edit runMode={classic,resampling_split_safe}, fieldMode={N,speed,mass}"
