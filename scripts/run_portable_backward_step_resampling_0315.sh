...
SEED="${SEED:-1628304}"; SUMMARY_EVERY="${SUMMARY_EVERY:-100}"; DUMP_STATE_EVERY="${DUMP_STATE_EVERY:-500}"
UIN="${UIN:-0.60}"; UINIT="${UINIT:-0.0}"; THERMOSTAT_ENABLE="${THERMOSTAT_ENABLE:-1}"
