...
CASE_LABEL="${CASE_LABEL:-air_assisted_atomizer_testHRe_ncalib_large}"
RUN_MODE="src-q6-g-f"
TOPOLOGY="segmented"
...
LIQUID_MASS="${LIQUID_MASS:-1.0}"; GAS_MASS="${GAS_MASS:-0.2  }"
...
SURFACE_TENSION_SIGMA="${SURFACE_TENSION_SIGMA:-16}"
...
LIVE_VIS_NX="${LIVE_VIS_NX:-800}"; LIVE_VIS_NY="${LIVE_VIS_NY:-400}"
...
RECORD_FIELDS="${RECORD_FIELDS:-rho1,rho2,ux,uy,alpha_x6c}"
