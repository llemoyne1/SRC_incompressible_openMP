...
# 0303 — Von Karman cylinder demo using the validated CUDA SRC classic path
# plus optional post-SRC CUDA resampling/support-control.  This script is
# deliberately independent of run_demo_src_classic_cuda_von_karman_cylinder_0285.sh
# so local experiments on 0285 do not affect the development demo suite.
...
# Hard reservoir and resampling share inactive slots.  Keep this generous for
