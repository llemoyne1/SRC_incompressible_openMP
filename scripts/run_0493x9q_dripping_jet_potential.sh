...
CASE_LABEL="dripping_jet_potential_0493x9q"
RUN_MODE="${RUN_MODE:-src-q6-g-f}"
TOPOLOGY=segmented
RUN_ROOT="${RUN_ROOT:-runs/0493x9q_dripping_jet_potential_long}"
CASES="${CASES:-capillary sigma0}"

# Square cells: h=0.005 by default.
Lx="${Lx:-1.0}"; Ly="${Ly:-1.5}"; NX="${NX:-200}"; NY="${NY:-300}"
GAMMA="${GAMMA:-20}"; DT="${DT:-0.002}"; KBT="${KBT:-0.00000125}"; STEPS="${STEPS:-80000}"
SEED="${SEED:-493940}"
LIQUID_TYPE="${LIQUID_TYPE:-1}"; GAS_TYPE="${GAS_TYPE:-2}"
GAS_MASS="${GAS_MASS:-1.0}"; LIQUID_MASS="${LIQUID_MASS:-10.0}"
...
SIGMA_ACTIVE="${SIGMA_ACTIVE:-75600.0}"
SURFACE_TENSION_MIN_RADIUS_CELLS="${SURFACE_TENSION_MIN_RADIUS_CELLS:-0}"
GRAVITY_Y="${GRAVITY_Y:--0.005}"
UIN="${UIN:-0.04}"
INLET_WIDTH_CELLS="${INLET_WIDTH_CELLS:-12}"
...
VACUUM_BACKGROUND="${VACUUM_BACKGROUND:-0}"
...
SUMMARY_EVERY="${SUMMARY_EVERY:-20}"; DUMP_STATE_EVERY="${DUMP_STATE_EVERY:-0}"
...
PARAMS
  ...
  printf '%s\n' \
    ...
    "[0493x9q-suite] objective=qualitative jet necking/pinch-off/drop fall/bottom impact; NOT calibrated wetting physics"
