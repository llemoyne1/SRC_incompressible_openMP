...
CASE_LABEL="dripping_vk_0493x10n_continuous_interface"
RUN_MODE="${RUN_MODE:-src-q6-g-f}"
TOPOLOGY=segmented
RUN_ROOT="${RUN_ROOT:-runs/0493x10n_continuous_interface_dripping_s1500_g01}"
CASES="${CASES:-capillary}"

# Square cells: h=0.005 by default.
Lx="${Lx:-1.0}"; Ly="${Ly:-1.5}"; NX="${NX:-200}"; NY="${NY:-300}"
GAMMA="${GAMMA:-20}"; DT="${DT:-0.002}"; KBT="${KBT:-0.125}"; STEPS="${STEPS:-1000}"
SEED="${SEED:-493940}"
...
SIGMA_ACTIVE="${SIGMA_ACTIVE:-1500.0}"
...
MPCD_X10N_Q6_CONTINUOUS_INTERFACE_WALL=1
MPCD_X10L_PREWALL_INTERFACE_DIAGNOSTICS=1
export MPCD_X10J_SIMPLE_SPECULAR_ABLATION MPCD_X10K_LOCAL_FRAME_SPECULAR_ABLATION MPCD_X10M_MOVING_INTERFACE_WALL MPCD_X10N_Q6_CONTINUOUS_INTERFACE_WALL MPCD_X10L_PREWALL_INTERFACE_DIAGNOSTICS
