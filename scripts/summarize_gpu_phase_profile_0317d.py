...
def main() -> int:
    if len(sys.argv) != 3:
        print('usage: summarize_gpu_phase_profile_0317d.py MANIFEST ART_DIR', file=sys.stderr)
        return 2
    ...
    write_csv(art_dir / 'gpu_phase_profile_0317d_summary.csv', summary_rows, [
    ...
    write_csv(art_dir / 'gpu_phase_profile_0317d_src_phase_breakdown.csv', phase_rows, [
        'target','repeat','phase','total_s','ms_per_step','percent_total'
    ])
    write_csv(art_dir / 'gpu_phase_profile_0317d_cuda_resident_breakdown.csv', resident_rows, [
    ...
    print(f'[0317d-summary] wrote {art_dir / "gpu_phase_profile_0317d_summary.csv"}')
    print(f'[0317d-summary] wrote {art_dir / "gpu_phase_profile_0317d_src_phase_breakdown.csv"}')
    print(f'[0317d-summary] wrote {art_dir / "gpu_phase_profile_0317d_cuda_resident_breakdown.csv"}')
    return 0
