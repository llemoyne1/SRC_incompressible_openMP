...
LIVE_VIS_NX="${LIVE_VIS_NX:-24}"
LIVE_VIS_NY="${LIVE_VIS_NY:-24}"
...
LIVE_VIS_WINDOW_SCALE="${LIVE_VIS_WINDOW_SCALE:-20}"
...
Lx="${Lx:-1.0}"; Ly="${Ly:-1.0}"; NX="${NX:-48}"; NY="${NY:-48}"
GAMMA="${GAMMA:-20}"; STEPS="${STEPS:-30000}"; DT="${DT:-0.001}"; KBT="${KBT:-1}"
SEED="${SEED:-1628303}"; SUMMARY_EVERY="${SUMMARY_EVERY:-100}"; DUMP_STATE_EVERY="${DUMP_STATE_EVERY:-200}"
UIN="${UIN:-0.8}"; UOUT="${UOUT:--0.8}"; THERMOSTAT_ENABLE="${THERMOSTAT_ENABLE:-1}"
