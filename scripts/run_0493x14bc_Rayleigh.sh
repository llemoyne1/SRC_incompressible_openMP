...
# -----------------------------------------------------------------------------
TARGET_RE_L="${TARGET_RE_L:-10}"
TARGET_WE_G="${TARGET_WE_G:-0.0002}"
TARGET_DENSITY_RATIO="${TARGET_DENSITY_RATIO:-1000}"
...
LIQUID_KBT="${LIQUID_KBT:-0.000078125}"
GAS_MASS="${GAS_MASS:-0.000003591954022988506}"
GAS_KBT="${GAS_KBT:-0.00000575}"
KBT="$GAS_KBT"
...
# -----------------------------------------------------------------------------
JET_DIAMETER_CELLS="${JET_DIAMETER_CELLS:-12}"
DOMAIN_DIAMETERS_X="${DOMAIN_DIAMETERS_X:-20}"
DOMAIN_DIAMETERS_Y="${DOMAIN_DIAMETERS_Y:-5}"
INITIAL_JET_LENGTH_OVER_D="${INITIAL_JET_LENGTH_OVER_D:-0.2}"
...
tsrc=0.0005*dt; tstar=tsrc*U/D; tb=tstar/6.0
