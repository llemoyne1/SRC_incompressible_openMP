...
RECORD_FIELDS="${RECORD_FIELDS:-rho,ux,uy,n}"; RECORD_EVERY="${RECORD_EVERY:-100}"; FILTER_MODE="${FILTER_MODE:-none}"; FILTER_SAMPLE_EVERY="${FILTER_SAMPLE_EVERY:-100}"; PARTICLE_TYPE_FILTER="${PARTICLE_TYPE_FILTER:--1}"
