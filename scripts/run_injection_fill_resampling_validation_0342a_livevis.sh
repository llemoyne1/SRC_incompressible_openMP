...
# Preserve explicit backend selections across cuda_env_clear_0431(). These are
# validation overrides of existing controls; normal runs keep the resident
# defaults below.
VALIDATE_IO_0264_0435D="${MPCD_CUDA_CLASSIC_SRC_IO_SEGMENTED_RESIDENT_0264:-1}"
VALIDATE_IO_0249B_0435D="${MPCD_CUDA_INLET_OUTLET_SEGMENTED_0249B:-1}"
VALIDATE_COLLISION_USE_0435D="${MPCD_CUDA_PERSISTENT_SRC_COLLISION_USE:-1}"
VALIDATE_COLLISION_SHARED_0435D="${MPCD_CUDA_PERSISTENT_SRC_COLLISION_SHARED_0251:-1}"
VALIDATE_THERMOSTAT_USE_0435D="${MPCD_CUDA_PERSISTENT_SRC_THERMOSTAT_USE:-}"
VALIDATE_THERMOSTAT_SHARED_0435D="${MPCD_CUDA_PERSISTENT_SRC_THERMOSTAT_SHARED_0251_0260:-1}"
VALIDATE_THERMOSTAT_SHARED_STRICT_0435D="${MPCD_CUDA_PERSISTENT_SRC_THERMOSTAT_SHARED_0251_0260_STRICT:-1}"
VALIDATE_THERMOSTAT_CONSUME_STRICT_0435D="${MPCD_CUDA_PERSISTENT_SRC_THERMOSTAT_CONSUME_STRICT:-1}"
...
cuda_env_for_case_0431() {
  local path=$1
  cuda_env_clear_0431
  export MPCD_CUDA_CLASSIC_SRC_IO_SEGMENTED_RESIDENT_0264="$VALIDATE_IO_0264_0435D"
  export MPCD_CUDA_CLASSIC_SRC_IO_SEGMENTED_RESIDENT_0264_STRICT="$VALIDATE_IO_0264_0435D"
  export MPCD_CUDA_INLET_OUTLET_SEGMENTED_0249B="$VALIDATE_IO_0249B_0435D"
  export MPCD_CUDA_PERSISTENT_SRC_COLLISION_USE="$VALIDATE_COLLISION_USE_0435D"
  export MPCD_CUDA_PERSISTENT_SRC_COLLISION_SHARED_0251="$VALIDATE_COLLISION_SHARED_0435D"
  export MPCD_CUDA_PERSISTENT_SRC_THERMOSTAT_CONSUME_STRICT="$VALIDATE_THERMOSTAT_CONSUME_STRICT_0435D"
  if path_has_q6_0431 "$path"; then
    ...
    export MPCD_CUDA_PERSISTENT_SRC_THERMOSTAT_USE="${VALIDATE_THERMOSTAT_USE_0435D:-0}"
    export MPCD_CUDA_PERSISTENT_SRC_THERMOSTAT_SHARED_0251_0260=0
    export MPCD_CUDA_PERSISTENT_SRC_THERMOSTAT_SHARED_0251_0260_STRICT=0
  else
    export MPCD_CUDA_PERSISTENT_SRC_THERMOSTAT_USE="${VALIDATE_THERMOSTAT_USE_0435D:-1}"
    export MPCD_CUDA_PERSISTENT_SRC_THERMOSTAT_SHARED_0251_0260="$VALIDATE_THERMOSTAT_SHARED_0435D"
    export MPCD_CUDA_PERSISTENT_SRC_THERMOSTAT_SHARED_0251_0260_STRICT="$VALIDATE_THERMOSTAT_SHARED_STRICT_0435D"
  fi
  if path_has_resampling_0431 "$path"; then
    ...
    export MPCD_CUDA_RESAMPLING_POPULATION_GUARD_0299_OPEN_BOUNDARY_HALO_CELLS="${MPCD_CUDA_RESAMPLING_POPULATION_GUARD_0299_OPEN_BOUNDARY_HALO_CELLS:-1}"
    export MPCD_CUDA_RESAMPLING_POPULATION_GUARD_0299_SOLID_HALO_CELLS="${MPCD_CUDA_RESAMPLING_POPULATION_GUARD_0299_SOLID_HALO_CELLS:-1}"
