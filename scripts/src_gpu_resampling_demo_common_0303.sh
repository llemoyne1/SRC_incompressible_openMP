...
MASS_RECONDITION_EVERY="${MASS_RECONDITION_EVERY:-${GUARD_EVERY:-20}}"
...
# 0308 consolidation: split-safety is the nominal CUDA resampling mode.
# It prevents repeated local splits from creating near-zero-mass representative
# particles, while keeping the existing post-SRC support-control ordering.
...
src_gpu_resampling_env_0303() {
  ...
  if resampling_demo_bool_on_0303 "$RESAMPLING_ENABLE"; then
    ...
    export MPCD_CUDA_RESAMPLING_SPLIT_SAFETY_0307="$SPLIT_SAFETY_ENABLE"
    ...
    export MPCD_CUDA_RESAMPLING_SOLID_ADJACENT_DONOR_MIN_MASS_0307="$SOLID_ADJACENT_DONOR_MIN_MASS"
    export MPCD_CUDA_RESAMPLING_SOLID_ADJACENT_HALO_CELLS_0307="$SOLID_ADJACENT_HALO_CELLS_0307"
    export MPCD_CUDA_RESAMPLING_TINY_MASS_THRESHOLD_0307="$TINY_MASS_THRESHOLD_0307"
  else
...
SPLIT_SAFETY_ENABLE=${SPLIT_SAFETY_ENABLE}
SPLIT_PREFER_MAX_MASS_DONOR=${SPLIT_PREFER_MAX_MASS_DONOR}
SPLIT_DONOR_MIN_MASS=${SPLIT_DONOR_MIN_MASS}
SPLIT_NEW_PARTICLE_MIN_MASS=${SPLIT_NEW_PARTICLE_MIN_MASS}
SOLID_ADJACENT_SPLIT_MODE=${SOLID_ADJACENT_SPLIT_MODE}
SOLID_ADJACENT_DONOR_MIN_MASS=${SOLID_ADJACENT_DONOR_MIN_MASS}
SOLID_ADJACENT_HALO_CELLS_0307=${SOLID_ADJACENT_HALO_CELLS_0307}
TINY_MASS_THRESHOLD_0307=${TINY_MASS_THRESHOLD_0307}
META
}
...
print_resampling_demo_banner_0303() {
  ...
  echo "[0308-demo] split safety: enable=$SPLIT_SAFETY_ENABLE preferMaxMass=$SPLIT_PREFER_MAX_MASS_DONOR donorMin=$SPLIT_DONOR_MIN_MASS newMin=$SPLIT_NEW_PARTICLE_MIN_MASS solidMode=$SOLID_ADJACENT_SPLIT_MODE"
}
