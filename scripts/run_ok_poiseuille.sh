...
GAMMA="${GAMMA:-8}"; STEPS="${STEPS:-30000}"; DT="${DT:-0.0063471328149122585}"; KBT="${KBT:-0.125}"
...
SEED="${SEED:-1628606}"; U0="${U0:-0.0}"; VELOCITY_MODE="${VELOCITY_MODE:-zero}"
...
SUMMARY_EVERY="${SUMMARY_EVERY:-100}"; DUMP_STATE_EVERY="${DUMP_STATE_EVERY:-500}"
