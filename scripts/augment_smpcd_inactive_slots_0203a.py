...
def main() -> int:
    if len(sys.argv) != 5:
        print("usage: augment_smpcd_inactive_slots_0203a.py SRC DST INACTIVE_SLOTS|auto INACTIVE_FACTOR", file=sys.stderr)
        return 2
    ...
    print(f"[0203a-state] active={n} inactive_added={extra} total={n2} output={dst}")
    return 0
