...
RUN_ROOT=${RUN_ROOT:-runs/channel_cylinder_resampling_0135}
...
CCYL_PROJECTION_MAX_ITERATIONS=${CCYL_PROJECTION_MAX_ITERATIONS:-500}
CCYL_PROJECTION_TOLERANCE=${CCYL_PROJECTION_TOLERANCE:-1.0e-10}
CCYL_Q6_WARM_START=${CCYL_Q6_WARM_START:-true}
CCYL_Q6_REUSE_PROJECTED_DIV_DIAG=${CCYL_Q6_REUSE_PROJECTED_DIV_DIAG:-true}
...
projectionMaxIterations = $CCYL_PROJECTION_MAX_ITERATIONS
projectionTolerance = $CCYL_PROJECTION_TOLERANCE
q6WarmStartEnable = $CCYL_Q6_WARM_START
q6ReuseProjectedDivergenceDiagnostics = $CCYL_Q6_REUSE_PROJECTED_DIV_DIAG
