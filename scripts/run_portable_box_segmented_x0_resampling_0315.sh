...
SEED="${SEED:-1628303}"; SUMMARY_EVERY="${SUMMARY_EVERY:-100}"; DUMP_STATE_EVERY="${DUMP_STATE_EVERY:-200}"
UIN="${UIN:-0.08}"; UOUT="${UOUT:--0.08}"; THERMOSTAT_ENABLE="${THERMOSTAT_ENABLE:-1}"
OUTLET_MODE="${OUTLET_MODE:-neumann}"
INACTIVE_SLOTS="${INACTIVE_SLOTS:-80000}"
BASE_RUN_ROOT="${BASE_RUN_ROOT:-runs/portable_box_segmented_x0_resampling_0315}"
run_mode_0315() {
...
cat > "$BASE_RUN_ROOT/visualize_box_segmented_x0_0315.m" <<MATLAB
% Visualization modalities for the segmented box validation.
...
MATLAB
echo "[0315-portable] MATLAB helper: $BASE_RUN_ROOT/visualize_box_segmented_x0_0315.m"
