...
BIN="${BIN:-build/src_mpcd_base_cuda_0315b_live}"
...
portable_resampling_env_0315() {
  ...
  if [[ "$mode" == "resampling" ]]; then
    ...
    export MPCD_CUDA_RESAMPLING_MASS_RECONDITION_0296_EVERY="${MASS_RECONDITION_EVERY:-${GUARD_EVERY:-1}}"
    ...
    export MPCD_CUDA_RESAMPLING_POPULATION_GUARD_0297_EVERY="${GUARD_EVERY:-1}"
    export MPCD_CUDA_RESAMPLING_POPULATION_GUARD_0297_NMIN="${GUARD_NMIN:-14}"
    export MPCD_CUDA_RESAMPLING_POPULATION_GUARD_0297_NTARGET="${GUARD_NTARGET:-20}"
    export MPCD_CUDA_RESAMPLING_POPULATION_GUARD_0297_NMAX="${GUARD_NMAX:-26}"
...
BASE_RUN_ROOT="${BASE_RUN_ROOT:-runs/live_tg_hole_0315b}"

RESAMPLING_SPLIT_SAFETY_0307=1
