...
VIRIAL_DENSITY_KICK_ENABLE=$VIRIAL_DENSITY_KICK_ENABLE
K_VIRIAL=$K_VIRIAL
BETA_EOS=$BETA_EOS
VIRIAL_MOMENTUM_CORRECTION_ENABLE=$VIRIAL_MOMENTUM_CORRECTION_ENABLE
VIRIAL_EFFECTIVE_SPEED=$VIRIAL_EFFECTIVE_SPEED
VIRIAL_DX=$VIRIAL_DX
VIRIAL_DY=$VIRIAL_DY
VIRIAL_CFL_X=$VIRIAL_CFL_X
VIRIAL_CFL_Y=$VIRIAL_CFL_Y
Q6_DENSITY_RELAXATION_BETA=$Q6_DENSITY_RELAXATION_BETA
Q6_DENSITY_RELAXATION_TIME=$Q6_DENSITY_RELAXATION_TIME
Q6_DENSITY_RELAXATION_EFFECTIVE_BETA=$Q6_DENSITY_RELAXATION_EFFECTIVE_BETA
Q6_DENSITY_RELAXATION_EFFECTIVE_TIME=$Q6_DENSITY_RELAXATION_EFFECTIVE_TIME
META
...
echo "[0493x5b] virialDensityKick=$VIRIAL_DENSITY_KICK_ENABLE Kvirial=$K_VIRIAL betaEOS=$BETA_EOS momentumCorrection=$VIRIAL_MOMENTUM_CORRECTION_ENABLE"
echo "[0493x5b] virialEOS=continuum Kunits=code_velocity_squared gradient=physical cEff=$VIRIAL_EFFECTIVE_SPEED d=($VIRIAL_DX,$VIRIAL_DY) CFL=($VIRIAL_CFL_X,$VIRIAL_CFL_Y)"
echo "[0493x5b] q6DensityRelaxation mode=$Q6_DENSITY_RELAXATION_MODE tau=$Q6_DENSITY_RELAXATION_EFFECTIVE_TIME betaPerStep=$Q6_DENSITY_RELAXATION_EFFECTIVE_BETA targetDiv=(rawFill-1)/tau scope=liquid_bulk_only"
echo "[0493x5b] ordering=tentative-force deposit -> liquid free-surface Q6/B1+density-RHS -> q6Applied diagnostic -> optional resident virial kick -> stream -> multispecies collision -> thermostat"
