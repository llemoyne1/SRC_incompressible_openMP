...
# 0299 — CUDA SRC classic build plus boundary-aware local population guard.
# This build keeps 0295/0296/0297/0298 and enables the 0299 boundary-aware filtering extension inside the population guard module.
...
OUT=${OUT:-build/src_mpcd_base_cuda_0299}

mkdir -p build
if ! command -v "$NVCC" >/dev/null 2>&1; then
  echo "[0299-cuda-build] ERROR: nvcc not found" >&2
  exit 2
fi
...
echo "[0299-cuda-build] Built $OUT"
