...
LIST="0493x10w_pairwise_static_qualification_files.txt"
ARCHIVE="0493x10w_pairwise_static_qualification_results.tar.gz"
: > "$LIST"

for d in \
    runs/0493x10w_pairwise_cold_control_* \
    runs/0493x10w_pairwise_hot_sigma3000_*
do
    [ -d "$d" ] || continue
