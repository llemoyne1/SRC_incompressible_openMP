...
# 0298 — CUDA SRC classic build plus post-SRC moment/energy restoration diagnostics.
# This build keeps 0295/0296/0297 and enables the 0298 cell-relative energy restoration extension inside the population guard module.
...
OUT=${OUT:-build/src_mpcd_base_cuda_0298}

mkdir -p build
if ! command -v "$NVCC" >/dev/null 2>&1; then
  echo "[0298-cuda-build] ERROR: nvcc not found" >&2
  exit 2
fi
...
echo "[0298-cuda-build] Built $OUT"
