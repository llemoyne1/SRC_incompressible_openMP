...
ORECT_XMIN=${ORECT_XMIN:-0.85}
ORECT_XMAX=${ORECT_XMAX:-1.10}
ORECT_YMIN=${ORECT_YMIN:-0.38}
ORECT_YMAX=${ORECT_YMAX:-0.62}
ORECT_FRACTION_SAMPLES=${ORECT_FRACTION_SAMPLES:-4}

ORECT_INLET_UX=${ORECT_INLET_UX:-0.08}
...
ORECT_MASS_RENORM_PERIOD=${ORECT_MASS_RENORM_PERIOD:-10}
...
run_case() {
    ...
    echo "[0138B] Running $label (projection=$projection, resampling=$resampling)"
