...
RUN_ROOT="${RUN_ROOT:-runs/run_ok_coalescence_${NX}x${NY}_g${GAMMA}_s${SIGMA_ACTIVE}}"
...
CENTER_OFFSET_X_CELLS="${CENTER_OFFSET_X_CELLS:-120}"
CENTER_OFFSET_Y_CELLS="${CENTER_OFFSET_Y_CELLS:-0}"
CENTER_OFFSET_X="${CENTER_OFFSET_X:-}"
CENTER_OFFSET_Y="${CENTER_OFFSET_Y:-}"
PAIR_CENTER_X="${PAIR_CENTER_X:-}"
PAIR_CENTER_Y="${PAIR_CENTER_Y:-}"
APPROACH_SPEED="${APPROACH_SPEED:-0.25}"
