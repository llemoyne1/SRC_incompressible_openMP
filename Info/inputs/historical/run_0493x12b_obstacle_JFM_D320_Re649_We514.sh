...
# 0493x12b — JFM-scaled D=320h obstacle splash using the existing Darcy/chi
...
CASE_LABEL="0493x12b_obstacle_JFM_D320_Re649_We514"
RUN_MODE="${RUN_MODE:-src-q6-g-f}"
TOPOLOGY=closed_box

CAMPAIGN_ROOT="${CAMPAIGN_ROOT:-runs/0493x12b_obstacle_JFM_D320_Re649_We514}"
CASES="${CASES:-rmin4}"
...
# Reasonable unattended recording for the splash transient.
LIVE_VIS_ENABLE=1
LIVE_VIS_FIELD=mass
LIVE_VIS_EVERY=1
...
RECORD_FORMAT=f32
RECORD_STRIDE=1
RECORD_EVERY="${RECORD_EVERY:-400}"
FILTER_MODE=none
FILTER_TAU=0.0
FILTER_SAMPLE_EVERY="${FILTER_SAMPLE_EVERY:-400}"
